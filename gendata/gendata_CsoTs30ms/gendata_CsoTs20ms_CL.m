...
modelname = ['CsoTs30ms', num2str(C), '_CL'];
seed = 24;
rng(seed);
...
nmin = -4; % noise minimum value (power of ten)
...
% savepath = '/home/joao/Documentos/GDRIVE/DOUTORADO/GIT/RaMSS_mat/DATA/Sampled/230424/';
savepath = '../DATA/SampledData/230905/';
